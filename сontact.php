...
?>
    ...
    <form action="check_contact.php" method="post">
        ...
        <div class="text-danger"><?=isset($_SESSION['error_username']) ? $_SESSION['error_username'] : ''?></div><br>
        ...
        <div class="text-danger"><?=isset($_SESSION['error_subject']) ? $_SESSION['error_subject'] : ''?></div><br>
